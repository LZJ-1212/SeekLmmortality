...
修订：2026-09-05 01:48 +08 lzj — 示例 env 日限改为默认不限

浏览器里的文字修仙：自然语言输入行动，**气血、修为、寿元、战斗与雷劫由后端硬算**，大模型只负责把既定结果写成剧情。生死有命，天道无常。

当前是可在本机完整体验的原型（创角、十二系统主路径、宣纸风 UI），不是上架商店的成品。声音、功法构筑、账号仍在规格阶段。S21 安全网关最小集（口令、可选日限、长度、黑名单）已落地。
...
# ACTION_DAILY_LIMIT=    不设则不限次；正整数才按北京日封顶
