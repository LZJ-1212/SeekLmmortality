...
## 三、 世界观与残酷修仙法则
- **真实死亡与境界压制**：弱肉强食，低境不能反杀高境，执意送死必须能陨落。倍率、秒杀阈值、五行**只认** [combat.md](./combat.md)（**I22 / B3**）。本白皮书不抄 0.4 / 秒杀档。AI 不得放水。
- **功德与业力**：行善积功德，杀人夺宝积业力[cite: 3]。业力过高将招致更强天罚，功德可用于抵御雷劫[cite: 3]。
- **灵根与六维**：每个数字干什么、仙缘是否摊祸，**只认** [character.md](./character.md)（**I28 / B15**）。创角合计约 60 点、中位 10；交手三维另夹 1～15。闭关乘式仍见下节。招式库仍 [combat_build.md](./combat_build.md)（S20）。

## 四、 核心数值计算公式

闭关月修为乘式**只认本节**（与 `cultivationFormula.service.ts` 对齐）。[character.md](./character.md) 只锁「资质/道心进本式」，不另抄展开。

- **修炼速度公式**：月修为增长 = 10 × 资质系数 × 灵根系数 × 功法系数 × 灵气系数 × 心境系数 × 天赋系数。
...
- **境界突破机制**（成册 [realms.md](./realms.md) **I21 / B2**）：
  - 小境界：修为达标直接突破，无雷劫。
  - 大境界：须过雷劫骰（成功率含道心与功德）。成败与寿元/气血覆盖**只认** [realms.md](./realms.md)，本白皮书不抄门槛与陨落率。

## 五、 十二大核心系统规划
1. 核心状态机（气血、灵力、寿元、时间）— 成册 [player_state.md](./player_state.md)（**I20 / B1**）
2. 境界突破与雷劫（含强制拦截器）— 成册 [realms.md](./realms.md)（**I21 / B2**；成仙锁档已落地；渡劫入钟未接线）
3. 时间与岁月流逝 — 并入 [player_state.md](./player_state.md)
4. 战斗与境界压制 — 成册 [combat.md](./combat.md)（**I22 / B3**；本场气血已落地；招式库仍见 [combat_build.md](./combat_build.md) / S20）
...
创角命格与开场 — 成册 [character.md](./character.md)（**I28 / B15**）。
